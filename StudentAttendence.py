...
#Send the captured image to AWS S3 Bucket--------------------------------------------------------------------------------------
    ...
    #Update the Rokognition ARN with yours   
        ...
        ProjectVersionArn='arn:aws:rekognition:ap-south1:413313710573:project/AttendanceManagementSystem/version/AttendanceManagementSystem.2023-11-05T18.37.57/1699189678901',
    ...
    if not len(response['CustomLabels']):
        ...
        url = "https://a8upzltoh1.execute-api.ap-south1.amazonaws.com/default/AttendFunction" + str
